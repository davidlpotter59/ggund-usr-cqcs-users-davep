...
string l_prog_number = "PRSPR097 - Version 4.50"
...
and sfsagent:agent_master_code one of 150
and sfsline2:exclude_from_contingent not one of 1

list
/nobanner
/domain="prsmaster"
/title="Direct Premiums Written and Unearned"
--/nodetail
/noreporttotals 
--/xls

if l_ytd_written <> 0 or
   l_unearned_factor <> 0 then 
{
prsmaster:agent_no 
sfsagent:name[1]/column=10/width=30
prsmaster:policy_no/column=37/mask="Z(9)"       
...
l_unearned_factor /nototal/column=250
}

sorted by  prsmaster:agent_no /total/newlines/heading="Total for @"
           prsmaster:policy_no 
