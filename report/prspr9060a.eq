...
sorted by sfsagent:agent_master_code /newlines 
          prspremloss:agent_no/newline
          prspremloss:line_of_business
--          prsmaster:lob_subline

top of sfsagent:agent_master_code
    "MASTER CODE "/column=15
    sfsagent:agent_master_code /noheading/column=25 
    sfsagent:name[1]/noheading /newline /column=31
...
"Master Agent Total"/column=15
sfsagent:agent_master_code/column=35/noheading 
