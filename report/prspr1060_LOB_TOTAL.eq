...
define signed ascii number l_incurred = (prspremloss:loss_reserve_current - prspremloss:loss_reserve_prior) + 
prspremloss:loss_paid_current 

define signed ascii number l_incurred_lae = 
((prspremloss:alae_reserve_current + prspremloss:ulae_paid_current) - ( prspremloss:alae_reserve_prior + prspremloss:ulae_reserve_prior)) +
...
sorted by --prspremloss:agent_no/newlines/newpage 
...
""/newline=2
total[prspremloss:loss_reserve_prior]/newline/heading="Prior Reserve"
total[prspremloss:loss_reserve_current]/newline/heading="Current Reserve"
total[prspremloss:loss_paid_current]/newline/heading="Current Paid"
