...
define string l_policy_management_copy = if policy_management_system_alt:policy_no= sfpname:policy_no then 
                                            policy_management_system_alt:copy_name 
...
l_policy_management_copy /heading="Copy"
