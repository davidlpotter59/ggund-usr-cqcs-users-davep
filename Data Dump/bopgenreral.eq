...
policy_no pol_year end_sequence prem_no build_no state county line_of_business construction sprinklers protection territory 
...
property_rate adjustment_factors optional_total bop_premium signs_limit signs_premium signs_deductible signs_not_attached_limit 
if sfpname_alias:trans_date >= 06.15.2011 and 
   sfpmaster_alias:irpm > 15 then
  15
else  
  sfpmaster_alias:irpm
sfpname_alias:trans_date
  sfpmaster_alias:irpm/heading="IRPM"
bopgeneral:signs_not_attached_premium glass_limit glass_premium glass_deductible include_glass_deductible burglary_limit_on burglary_limit_off
 burglary_premium money_limit_on money_limit_off money_premium attach_bu5001 fire_limit fire_premium construction_year alarm_option
 alarm_credit alarm_factor loss_years location_credit wind_deductible loss_income_limit limit_loss_income loss_income_percent 
